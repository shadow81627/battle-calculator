...
<template>
  <div class="relative inline-block text-left" v-on-click-outside="close">
    <div>
      <button type="button" class="w-full inline-flex justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold shadow-sm" aria-expanded="true" aria-haspopup="true" @click="toggleShow">
        Lists
