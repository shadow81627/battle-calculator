    ...
    <tbody>
      <template v-for="(weapon, index) of unit.weapons " :key="weapon.name">
        <template v-if="!weapon.profiles">
          <tr>
            <td :class="cellClasses(index)" width="100%" class="table-cell border-none text-center sm:hidden" colspan="8">
        ...
        <template v-else>
          <template v-for="(profile, index) of weapon.profiles " :key="profile.name">
            <tr>
              <td
                :class="profileClasses(index, weapon.profiles.length)" width="100%"
                class="table-cell border-none text-center sm:hidden" colspan="8"
              >
            ...
            <tr>
              ...
              <td class="hidden px-2 sm:table-cell" width="50%" :class="profileClasses(index, weapon.profiles.length)">
                {{ profile.name }}
              </td>
