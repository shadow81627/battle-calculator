...
<template>
  <div style="width:282mm; height:210mm; display: flex;" class="mx-auto avoid-page-break" :class="{
    'page-break': onePerPage, '!print:hidden': hide,
  }">
    <div class=" mx-auto" style="font-weight: 500; margin-bottom: 32px; display: flex;
  flex-direction: column; flex-grow: 1;">
      <label class="print:hidden flex justify-end gap-4 pb-2">
      ...
      <div class="flex-grow !print:border-t-2 border-t-0 border-2 border-solid"
        ...
        <div class="pt-5"
          ...
          <table cellspacing="0" class="weapons-table" style="width: 100%">
            <FancyScribeWeapons title="RANGED WEAPONS" :weapons="rangedWeapons" :model-stats="modelStats"
              :force-rules="forceRules" />
            <FancyScribeWeapons title="MELEE WEAPONS" :weapons="meleeWeapons" :model-stats="modelStats"
              :force-rules="forceRules" />
          </table>
